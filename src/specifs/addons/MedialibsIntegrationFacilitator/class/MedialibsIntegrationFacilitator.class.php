...
class MedialibsIntegrationFacilitator extends \Addons_Entity
{
  // singleton
   ...
   *
   * @return  \Addon\MedialibsIntegrationFacilitator\MedialibsIntegrationFacilitator
   */
  ...
  {
    return '/images/addons/MedialibsIntegrationFacilitator/';
  }
}
