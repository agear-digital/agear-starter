...
class MedialibsSaytupMicroDataConfigurator extends \Addons_Entity
{
  // singleton
   ...
   *
   * @return  \Addon\MedialibsSaytupMicroDataConfigurator\MedialibsSaytupMicroDataConfigurator
   */
  ...
  {
    return '/images/addons/MedialibsSaytupMicroDataConfigurator/';
  }
}
