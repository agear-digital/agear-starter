...
class MedialibsPlaceholderManager extends \Addons_Entity
{
  // singleton
   ...
   *
   * @return  \Addon\MedialibsPlaceholderManager\MedialibsPlaceholderManager
   */
  ...
  {
    return '/images/addons/MedialibsPlaceholderManager/';
  }
}
