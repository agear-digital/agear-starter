...
class MedialibsTextAndImages extends \Addons_Entity
{
  // singleton
   ...
   *
   * @return  \Addon\MedialibsTextAndImages\MedialibsTextAndImages
   */
  ...
  {
    return '/images/addons/MedialibsTextAndImages/';
  }
}
