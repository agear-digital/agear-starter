...
class MedialibsBreadcrumbMicroData extends \Addons_Entity
{
  // singleton
   ...
   *
   * @return  \Addon\MedialibsBreadcrumbMicroData\MedialibsBreadcrumbMicroData
   */
  ...
  {
    return '/images/addons/MedialibsBreadcrumbMicroData/';
  }
}
