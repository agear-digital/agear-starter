...
class MedialibsHTMLDateRenderer extends \Addons_Entity
{
  // singleton
   ...
   *
   * @return  \Addon\MedialibsHTMLDateRenderer\MedialibsHTMLDateRenderer
   */
  ...
  {
    return '/images/addons/MedialibsHTMLDateRenderer/';
  }
}
